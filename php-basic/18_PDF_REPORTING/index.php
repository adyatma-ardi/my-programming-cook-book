...
<head>
    ...
    <style>
        ...
        /* PDF print - langsung melalui web browsernya */
        @media print {
...
<body>
    ...
    <br>
    <p><a href="tambah_modular.php" class="tambah">tambah data mahasiswa (modular)</a></p>
    <p><a href="tambah_nonmodular.php" class="tambah">tambah data mahasiswa (non_modular)</a></p>
    <br>
